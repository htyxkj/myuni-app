<template>
	<view>
		...
		<mescroll-uni @down="downCallback" @up="upCallback" @init="mescrollInit" :up="upOption" :showUpBtn="true" :down="downOption" :fixed="true" :top="230" :bottom="100" class="bg-white">
