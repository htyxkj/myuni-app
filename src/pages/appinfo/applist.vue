<template>
	<view>
		...
		<mescroll-uni @down="downCallback" @up="upCallback" @init="mescrollInit" :up="upOption" :showUpBtn="true" :down="downOption" :fixed="true" :top="260" :bottom="100" class="bg-white">
...
export default class appList extends Vue {
	...
	async onLoad(option: any) {
		if (option.pbuid) {
			...
			// console.log(JSON.parse(uni.getStorageSync(pbuid)))
