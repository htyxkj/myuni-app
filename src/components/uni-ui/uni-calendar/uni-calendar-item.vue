...
@Component({})
export default class UniCalendarItem extends Vue {
	/**
	 * 当前日期
	 */
	@Prop({ type: Object, default: {} }) canlender!: object;
	@Prop({ type: Boolean, default: false }) lunar!: boolean;

	selectDays(week: Object, index: Object, ischeck: Object, isDay: Object, lunar: Object) {
