<template>
	<view :class="'uni-icon-' + type" :style="{ color: color, 'font-size': size + 'px' }" class="uni-icon" @click="onClick" />
</template>

<script lang="ts">
import { Vue, Watch, Prop, Component, Inject } from 'vue-property-decorator';
@Component({})
export default class UniIcons extends Vue {
	@Prop({ type: String, default: '' }) type!:string;
	@Prop({ type: String, default: '#333333' }) color!:string;
	@Prop({ type: [Number, String], default: 16 }) size!:number;
	onClick() {
		this.$emit('click');
	}
}
