...
export default class extends Vue{
	@Provide() name: string = 'UniLoadMore'
	@Provide() platform:any = platform
	@Prop({type: String,default: 'more'})  status!:string
	@Prop({type: String,default: 'auto'})  iconType!:string
	@Prop({type: String,default: '#777777'})  color!:string
	@Prop({type: Object,default:{contentdown: '上拉显示更多',
          contentrefresh: '正在加载...',
